...
<div class="container">
            <h1 class="text-center equipo-titulo">Yo puedo ser tu amigo Fiel <iconos.pata style={{ fontSize: 60 }}/></h1>
            <br><br>
            <div class="tarjeta-equipo">
                <br />
            <h1 class="text-center fs-5">SHEILA</h1>
            <div class=" mb-3">
            <div class="row g-0">
                ...
                <div class="col-md-5">
                <div class="card-body texto-equipo">
                    <p class="card-text">Información de Animal:</p>
                    <hr/>
                    <p class="card-text">Sexo:</p>
                    <p class="card-text fw-normal">Hembra</p>
                    <p class="card-text">Edad:</p>
                    <p class="card-text fw-normal">Adulto/Nacimiento:01//2011</p>
                    <p class="card-text">Raza:</p>
                    <p class="card-text fw-normal">Maztín</p>
                    <p class="card-text">Tamaño:</p>
                    <p class="card-text fw-normal">Grande</p>
                    <p class="card-text">Caracter:</p>
                    <p class="card-text fw-normal">Activa</p>
                    <hr/>
                </div>
            ...
            <a href="./formularioAdopcion.php" class="button1" type="button">Solicitar Adopción</a>
            <a href="../.././index.php" class="button2" type="button">Volver a Inicio</a>
